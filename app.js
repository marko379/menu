...
buttons.forEach(function(button){
  let menuCategories = button.addEventListener('click',function(e){
    category = button.dataset
    if(category.id === 'breakfast'){
      let breakfastMenu = menu.filter(function(breakfastItems){

        return breakfastItems.category == category.id
      }); displayMenuItems(breakfastMenu)
    }
    else if(category.id === 'shakes'){
        let shakesMenu = menu.filter(function(shakesItems){
          return shakesItems.category == category.id
